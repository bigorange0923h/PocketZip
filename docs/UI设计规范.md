...
PocketZip 采用 **3D Elements** 设计风格，通过 CSS 3D、透视、分层阴影和光晕，在二维屏幕上营造「屏幕里有实体装置」的视觉错觉。

### 1.1 风格定位

3D Elements 风格适用于需要突出科技感、创新力和高价值感的场景。它不适合信息极度密集、强调纯效率的后台，而更适合「第一印象很重要」「需要强烈视觉记忆点」的页面。

PocketZip 作为一款轻量解压工具，采用此风格可以：
...
*本规范基于 3D Elements 设计风格制定，作为 PocketZip 前端开发的视觉指导。*
